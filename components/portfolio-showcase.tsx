...
export function PortfolioShowcase() {
  ...
  return (
    <section className="relative py-24 overflow-hidden bg-linear-to-b from-zinc-50/50 to-white dark:from-zinc-900/50 dark:to-zinc-950">
      ...
      <div className="container relative mx-auto px-4 mb-16">
        <div className="text-center max-w-3xl mx-auto">
          ...
          >
            Real projects, real results. Built with Next.js, deployed on Vercel,
      ...
      <div className="relative">
        ...
        <div className="absolute left-0 top-0 bottom-0 w-32 bg-linear-to-r from-white via-white/80 to-transparent z-10 dark:from-zinc-950 dark:via-zinc-950/80" />
        <div className="absolute right-0 top-0 bottom-0 w-32 bg-linear-to-l from-white via-white/80 to-transparent z-10 dark:from-zinc-950 dark:via-zinc-950/80" />
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <div className="flex items-center gap-2 mb-2">
                          <span
                            className={`inline-flex h-5 w-5 rounded-full bg-linear-to-r ${item.gradient}`}
                          />
